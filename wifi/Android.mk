...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.viva.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.viva.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.viva
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.viva.rc \
    android.hardware.wifi@1.0-service.viva.xml
